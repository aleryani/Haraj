     ...
     if(isset($result['product'])) {
         ...
         foreach($products as $product){
			...
			$output.="<div class='ad-item row'>";
					...
					$output.="<a onclick=approveProduct(this,event,'{$product['product_id']}') class='edit-item' href='#' data-toggle='tooltip' data-placement='top' title='Approve'><i class='fa fa-thumbs-up'></i></a>";
					$output.="<a class='delete-item' href='#' data-toggle='tooltip' data-placement='top' title='Delete this ad'><i class='fa fa-times'></i></a>";
					$output.="</div>";
					$output.="</div>";
					$output.="</div>";
					$output.="</div>";
...
<?php echo $output; ?>  
	...
	<script>
		function approveProduct(obj,e,id)
		{
			e.preventDefault()
